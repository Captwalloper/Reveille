...
namespace Reveille
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnActivated(IActivatedEventArgs e)
        {
            ...
            bool app_activated_by_voice_command = e.Kind == Windows.ApplicationModel.Activation.ActivationKind.VoiceCommand;
            if (app_activated_by_voice_command)
            {
                RespondToVoiceCommand(e as VoiceCommandActivatedEventArgs, page);
            }
        }
        ...
        private void InitializeFrame(LaunchActivatedEventArgs e)
        {
            ...
            if (rootFrame.Content == null)
            {
                ...
                // parameter
                rootFrame.Navigate(typeof(Reveille.View.MainPage), e.Arguments);
            }
